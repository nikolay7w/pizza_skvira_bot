...
async def load_description(message: types.Message, state: FSMContext):
    if message.from_user.id == ID:
        ...
        await FSMAdmin.next()
        return await message.reply('Вкажіть ціну')


# Последний хендлер и используем полученіе данніе
# @dp.register_message_handler(state=FCMAdmin.price)
...
def register_handlers_admin(dp: Dispatcher):
    ...
    dp.register_message_handler(delete_item, commands=['Видалити'], state=None)
